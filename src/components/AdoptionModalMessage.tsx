...
export default function AdoptionModalMessage({
  visible,
  onClose,
  messageData,
}: Props) {
  ...
  const handleWhatsApp = () => {
    // TODO: Lógica para abrir WhatsApp
    console.log("Abrir WhatsApp con:", messageData.phone);
  };

  const handleReject = () => {
    // TODO: Lógica para rechazar/eliminar mensaje
    console.log("Rechazar solicitud:", messageData.id);
  };
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View
              style={[
                styles.statusBadge,
                { backgroundColor: messageData.isRead ? "#999" : "#4CAF50" },
              ]}
            >
              <Text style={styles.statusText}>
                {messageData.isRead ? "LEÍDO" : "NUEVO"}
              </Text>
            </View>
          </View>
