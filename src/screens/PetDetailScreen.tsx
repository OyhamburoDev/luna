        ...
        >
          ...
          <View style={styles.infoCardsGrid}>
            {[
              ...
              <View
                key={index}
                style={[styles.infoCardCompact, { borderTopColor: item.color }]}
              >
          ...
          {showMore && (
            <View style={styles.infoCardsGrid2}>
              {extraFields.map((key, index) => {
                const color = extraFieldColors[index % extraFieldColors.length]; // Asigna color cíclicamente
                return (
                  <View
                    key={index}
                    style={[styles.infoCardCompact2, { borderTopColor: color }]}
                  >
                    <Ionicons
...
const styles = StyleSheet.create({
  ...
  contentContainerAbsolute: {
    position: "absolute",
    top: height * 0.35 - 30, // Inicia 30px antes del final del media
    left: 0,
    right: 0,
